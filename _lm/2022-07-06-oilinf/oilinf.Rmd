...
```{r img-dyn, echo=FALSE, fig.align='center', out.extra="class=external"}
...
```{r img-defi, echo=FALSE, fig.align='center', out.extra="class=external"}
...
```{r img-inlimp, echo=FALSE, fig.align='center', out.extra="class=external"}
...
```{r img-tr1, echo=FALSE, fig.align='center', out.extra="class=external"}
...
```{r img-tr2, echo=FALSE, fig.align='center', out.extra="class=external"}
