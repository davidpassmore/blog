...
dplyr::tribble(
  ...
  tab_source_note(
    source_note = md("*Source:* Commonwealth of Pennsylvania (2015" )
  ) %>%
  tab_style(
  ...
  cols_align(
    align = "center",
    columns = "Permitted Emission Rate (tons)"
  ) %>%
...
```{r tab2, echo=FALSE}
tab2 <- read_csv('tab2new.csv')
tab2 %>% 
  gt() %>%
   tab_header(title = md("Table 2. *Potential Annual Economic Impact of
Operation of a Petroleum Refinery in Beaver County, Pennsylvania*"),
subtitle = md("(millions of dollars or number of jobs)")) %>%
  tab_source_note(source_note = md("*Source:* Clinton, Minutolo, and O’Roark 2021b")) %>%
  cols_align(
    align = "center",
...
```{r tab3, echo=FALSE}
tab3 <- read_csv('tab3.csv')
tab3 %>% 
  gt() %>%
   tab_header(title = md("Table 3. *Potential 40-Year Economic Impact of
Operation of a Petroleum Refinery in Beaver County, Pennsylvania*"),
subtitle = md("(millions of 2020 dollars
