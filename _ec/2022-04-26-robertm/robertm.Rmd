...
auto components. Polyethylene is produced from ethylene from steam
...
we are tying the various larger structures together" [@suttles2020]. One
...
doorstep of your customer [@cocklin2016]." Leaders of oil and gas
...
only the U.S. itself and Russia" [@callahan2022]. More than 70% of the
North American polyethylene market exists within a 700-mile radius of
the Complex [@pennsylvc, "Project development"].
...
-   First, I delineate some of the questions that remain for me about
...
-   Next, I outline my simple understanding of the steps operating the
    Pennsylvania Petrochemicals Complex. Understanding the nature and
    structure of inputs, processes, and outputs shapes expectations for
...
raise taxes to remain revenue-neutral [@sammartino2020, p. 4]. In 2019,
...
governments over 20 years [@crisafulli].

IIf projects were judged on costs alone, few investments would occur.
Instead, citizens must weigh the costs of this public investment in this
private venture against the benefits distributed to the regional economy
...
were demonstrated well before the operation of the Complex.
...
have been impossible without Act 2 funds [@cocklin2016b, ¶7].
...
Complex's construction phase [@cocklin2016c, ¶4].
...
years, a rough, undiscounted calculation[^5] indicates a cost per job, a
...
and flexible [@bumsted2012]. Shell's Visser said, "I can tell you, with
hand to my heart, that without these incentives, we would not have made
this investment decision [@cocklin2016a, ¶6]." Governor Corbett, who
...
had we done nothing, had we let these businesses go" [@detrow2012].
...
decided to relocate to West Virginia, Ohio, and Pennsylvania region, if
...
Shell's success also could positively impact on the regional economy in
...
the regional economy is incidental and is not essential for Shell's
...
exchange for a modest job and investment possibilities derived in the
...
backward on the American Chemistry Council reports conducted similarly
...
successful? It successful?*] [@remarks2019]." Governor Tom Corbett said,
"The benefits to the state's southwest and to all of Pennsylvania are
immense" [@gibson2012, ¶9]. Corbett felt that public investment in the
...
education, for social services" [@detrow2012, ¶19].
...
of the recent report from Robert Morris University, criticisms which I
...
ethane cracker units,[^8] two high-density polyethylene units and one
...
\@ref(fig:img-falcon)). Ethane transported by Falcon is unique --- it is
...
become the "wet" portion of the natural gas [@hey2017]. In general,
Marcellus and Utica shale formations in Ohio, southwestern Pennsylvania,
and West Virginia involve wet gas (See Figure \@ref(fig:img-wet) for
locations).
...
ethylene (more detail in @passmore2022a, para, 5).
...
hydrogen in the process and creating a double bond[^11] between carbon
atoms (structures modeled in Figure \@ref(fig:img-crack)). The hot gas
mixture exhausted from the cracker is cooled, or "quenched [@quenchw],"
...
in a controlled combustion process called "flaring" [@flaring], which
...
indicated for the Complex.[^12] I have not found any indication that
...
released into the environment (see discussion by @mcveigh).
...
Figure \@ref(fig:img-flowm) revealed that almost two-thirds of workers
...
the IMPLAN software to initiate the estimates in Table 1.[^20] Some
...
<thead>
  <tr>
    <th class="tg-yziz" colspan="3"><span style="color:#000">Table 2. </span><span style="font-style:italic;color:#000">Potential Annual and 40-Year Regional Economic Impact of </span><br><span style="font-weight:400;font-style:italic;color:#000">Operation of </span><span style="font-style:italic;color:#000">a Petroleum Refinery in Beaver County, Pennsylvania </span></th>
  </tr>
</thead>
<tbody>
  <tr>
...
Bureau of Economic Analysis [@nipahan2021; @glossarya]. Others are
derived from the language used around input-output analysis [@clouse].
...
impact, even though sophisticated research tools are applied.
...
using...proprietary [input-output] models [@economic2017a]". I am not
...
representatives. The problems, I believe, lie in the lack of due
...
cynically but fully believe that firms like Shell should pursue
...
only evidence of the potential economic impact that reinforced public
...
select the Petroleum Refineries industry analyzed by @clinton2021 rather
...
they produce [@whatisa]. The @northam says, "Economic units that have
...
services/operations are performed.[^21] Generally, accounting for the
production flow moves from establishments within firms and then is
aggregated to industries.

[^21]: If employees normally do not work at a single physical location,
...
include products made from natural gas liquids. However, the authors of
...
Petrochemicals Complex, for these reasons that they give:
...
value added, labor income, and taxes.[^22]

[^22]: Refer to Table 2 to explore further what appears to be very high
    dollar of value added per direct worker.
...
impact of the Pennsylvania Petrochemicals Complex.[^23] IMPLAN, the
...
[^23]: A 40-year span of life of the Complex might seem like a rather
...
experiments[^24] to make these comparisons valid and fair. As far as I
know, the Commonwealth does not plan to perform such an assessment.

[^24]: Assessing the impact of the operation of the Complex is a complex
...
@environmentallawinstitute2018 and @doyle identified by-products of the
...
smelled.[^25] Some synthesis of these approaches is desirable in future
assessments of the Complex. The concepts and tools of economic analysis
might present a path for this synthesis.

[^25]: David Foster Wallace in *This is Water* tells a little didactic
...
Another approach is to collect a "Pigouvian" tax[^26] that pays for the
...
[^26]: A Pigouvian tax takes its name from Arthur Pigou, the English
...
as calculating a moral or prudential algebra[^27] -- might result in
...
[^27]: See a September 19, 1772 letter from Franklin to chemist Joseph
...
at Penn State University, provided guidance integration of Zotero a
bibliographic citations database, to this blog. Ms. Cahoy is my only
librarian now that I am retired from Penn State. But, even better, she
has been my best librarian throughout my career at Penn State. Believe
