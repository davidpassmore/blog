...
dplyr::tribble(
  ...
  tab_header(
    title = md("Table 1. *Tons of Permitted Annual Emissions by the Complex*"),
  ) %>%
  tab_source_note(
    source_note = md("*Source:* Air Quality Plan Approval Application: Petrochemicals Complex, Shell Chemical Appalachia LLC, Beaver County, Pennsylvania, Emission Restriction #005" )
  ) %>%
  tab_style(
