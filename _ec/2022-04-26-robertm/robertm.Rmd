...
-   And, last, I critically examine a report by professors associated
    ...
    [@clinton2021a], was produced before the Complex will open for business.
...
According to a biting 2020 opinion offered by @sanzillo2020, the Pennsylvania Petrochemical
...
[@kolb2014], in Pennsylvania and other states in the northeast United States. The Commonwealth of Pennsylvania did not produce its own
...
successful? It work?*] [@remarks2019]." Governor Tom Corbett said,
...
Displayed in Figure \@ref(fig:img-processF) is my conception of the inputs, processes, and
...
derived from the language used around input-output analysis [@clouse]. Readers of reports of economic impact often impute different meanings of economic and technical concepts and methods than are intended by producers of reports.
...
components shown in Figure \@ref(fig:img-outp) are terms used in national income
