...
#### Are Tax Expenditures as Incentives Effective?
...
```{r img-trump, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%' , fig.cap='*Former President Trump Visits Site of Pennsylvania Petrochemicals Complex, August 2019* <br> (Image from https://tinyurl.com/trumpvisit)'}
...
```{r img-nurd, echo=FALSE, fig.align='center', fig.retina = 2,  out.extra="class=external", out.width='25%' , fig.cap='*White Nurdles.* <br> (Photo from gentlemanrook - originally posted to Flickr as Plastic Pellets - &quot;Nurdles&quot;, <br> CC BY 2.0, https://commons.wikimedia.org/w/index.php?curid=4487785)'}
...
| *Source:* \@ c o m          |                |
| m                           |                |
| onwealthofpennsylvania2015, |                |
| Emission Restriction #005   |                |
+-----------------------------+----------------+
...
## How Well Understood is the <br> Potential Economic Impact of Complex?
...
```{r img-outp, echo=FALSE, fig.align='center', out.extra="class=external", fig.cap='*Relationships Among Some of the Components of Regional Economic Output, <br> Most of Which Are Estimated in the Robert Morris Report.*<br> (Image captured and recolored from https://bit.ly/IMPLANoutput)'}
...
```{r img-multiply, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%' , fig.cap='*Components the Total Economic Impact of the Pennsylvania Petrochemicals Complex.* <br> (Graphic drawn by David Passmore using DiagrammeR package in RStudios.)'}
knitr::include_graphics("https://davidpassmore.net/blogd/img/multeff.png")
```

#### Did Economics Play a Role in the Assessment of the Potential Economic Impact?
...
```{r img-smallpr, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%' , fig.cap='*Ethylene is Generated at the Complex as an Input for Polymerization. <br> Ethylene is not an output for Sale to Customers. <br> Polymerized Plastic Pellets Form the Major Output of the Complex.* <br> (Graphic drawn by David Passmore using DiagrammeR package in RStudios.)'}
...
#### Validity of a 40-Year Forecast of Impact
