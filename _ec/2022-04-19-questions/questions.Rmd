...
```{r img-rend, echo=FALSE, fig.align='center', fig.retina = 2,  fig.cap='Rendering of the Soon-To-Be-Completed Pennsylvania Petrochemicals Complex'}
...
```{r img-mole, echo=FALSE, fig.align='center', fig.retina = 2,   fig.cap='Ethane Molecules are Cracked to Form Ethylene Molecules'}
...
```{r img-googm, echo=FALSE, fig.align='center', fig.retina = 2, fig.cap='Google Map of Location of Pennsylvania Petrochemicals Complex'}
