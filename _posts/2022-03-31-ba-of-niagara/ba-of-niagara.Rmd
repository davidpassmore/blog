...
```{r img-post, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%', fig.cap='The Great Gorge of Niagara, a postcard'}
knitr::include_graphics("greatg.jpeg")
```


Over a low stone wall across the road is the Great Gorge of Niagara. I am sitting in a breakfast cafe of a Canadian hotel about one mile downstream from the Falls of Niagara. Both great waterfalls, the Horseshoe Falls and the American Falls, are on duty, even before a significant Western secular and worldwide spiritual holiday like Christmas day.

For ages, the water flowed and fell, slowly carving an abyss through the Lockport Dolomite stone formation predominant in the region. This flow has stepped the brink of the waterfalls backward over the equally vast chasm of time of far greater depth of space and length of time than is pictured in the cheap trinket shops, tourist traps, and manufactured "great views" that now populate its shores and exploit its beauty.

Yes, the Niagara River rolls and boils on. Geologists tell us that the Falls of Niagara eventually will become the Falls of Buffalo (20 miles upstream) as the river cuts its way, inch by inch, between Lake Erie and Lake Ontario, two of the so-called Great Lakes in the United States of America. I will become less than dust in the fullness of time, swept up and diffused about the world to land into hamlets in Austria and wells in China and, without rest, whisked around by the sharp, unrelenting winds of Patagonia. I will become someone else's grit and grime. But, the Falls will continue relentlessly and without regard for the dust of me and of the millions who have stared at it in awe and captured its dynamic image on tiny Kodak Brownie cameras.

The Great Gorge across the road is less than a quarter-mile wide and is perhaps, 300 feet deep. The Gorge is more than a physical separation between two pieces of land. Sure, it politically separates Canada and the United States of America. Also, it separates two cultures, Canadian and American, which deceive us by seeming similar. 

Canada and the United States share television, radio, news, products, and production. Each country's money is discounted and exchanged daily across each other's borders. Then, of course, there is ice hockey, which knows no boundaries, does it? And, the two countries' peoples are friends -- most of the time, in spite of our use of the word "napkin" while they use instead "serviette." Yet, the subtle differences in socialization, temperament, values, and, if it is possible to use such a hefty word, culture between the two countries are easy to miss. One hint is in the difference in the sound of spoken language.

```{r img-whirlpool, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%', fig.cap='A giant whirlpool downstream from the Falls'}
knitr::include_graphics("niagarag.jpeg")
```
...
```{r img-map, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%' , fig.cap='Google Map of Niagara Region'}
knitr::include_graphics("NHmap.jpg")
```
