...
```{r img-with-knitr, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%', fig.cap='On the Capitol Steps, 1978'}
knitr::include_graphics("Passmore_Grassley.jpg")
```

He was testing me, I think. He warmed considerably after that debate as we talked about his farm, our families, and Iowa. It was a great meeting, after which we had a photograph in Fig. \@ref(fig:img-with-knitr) taken on the Capitol Building steps.
