...
description: |
  Maybe this dry, geeky eesay won't shock your soul, but it describes input-output models, their assumptions, & their uses for estimating economic impact of grand public investments.
...
Assumptions undergird all models, which are the entity itself but are an
