...
```{r img-post, echo=FALSE, fig.align='center', fig.retina = 2,  fig.cap='The Great Gorge of Niagara, a postcard'}
...
```{r img-whirlpool, echo=FALSE, fig.align='center', fig.retina = 2, fig.cap='A giant whirlpool downstream from the Falls'}
...
```{r img-hosp, echo=FALSE, fig.align='center', fig.retina = 2,  fig.cap='Now-demolished St Marys Hospital, 6th Steet, Niagara Falls, New York'}
...
```{r img-street, echo=FALSE, fig.align='center', fig.retina = 2,   fig.cap='Honky-Tonk Niagara Falls'}
...
```{r img-map, echo=FALSE, fig.align='center', fig.retina = 2,  fig.cap='Google Map of Niagara Region'}
