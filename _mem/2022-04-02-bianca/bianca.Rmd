...
```{r img-bsnow, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%', fig.cap='Bianca loved napping in the snow on a sunny day'}
knitr::include_graphics("bsnow.jpeg")
```


And, here, another photo a few minutes before I took her to the vet:

```{r img-bb4, echo=FALSE, fig.align='center', fig.retina = 2,  out.width='25%', fig.cap='Curled up like greyhounds do'}
knitr::include_graphics("bb4.jpeg")
```


>You think dogs will not be in heaven?  I tell you, they will be there long before any of us.   ~Robert Louis Stevenson

##### Added years After This Original 2007 Posting
