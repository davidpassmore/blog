...
```{r img-bsnow, echo=FALSE, fig.align='center', fig.retina = 2,   fig.cap='Bianca loved napping in the snow on a sunny day'}
...
```{r img-bb4, echo=FALSE, fig.align='center', fig.retina = 2,   fig.cap='Curled up like greyhounds do'}
